...
################################################################################
######## Tema : Regresi?n Log?stica,Logística Penalizada,Naive Bayes  - KNN ####
...
## supuestos
#por defecto pearson, en caso de querer spearman, colocar el par?metro.
cor(Train[,2:8])
...
#Estandariza la data para cumplir el supuesto de KNN
